...
func (c *userService) GetUserByName(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *userServiceHandler) GetUserByName(ctx context.Context, in *Request, out *Response) error {
